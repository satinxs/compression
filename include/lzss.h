...
_API error_t lzss_encode(lzss_config_t config, buffer_t input, buffer_t *output);

_API error_t lzss_get_original_length(buffer_t input, u32 *original_length);
_API error_t lzss_decode(lzss_config_t config, buffer_t input, buffer_t *output);
